      ...
      <Link href={`/products/${product.slug}`} style={{ color: "inherit", display: "block" }}>
        ...
        >
          {product.primaryImage && (
            <Image
              ...
              style={{ objectFit: "cover", transition: "transform 1s var(--ease-maison)" }}
            />
          )}
          {alternateImage && (
            <Image
          ...
          {badge && (
            <span
              style={{
                ...
                top: "1rem",
                left: "1rem",
                background: badge.className === "bestseller" ? "var(--clay)" : badge.className === "new" ? "var(--ink)" : "var(--bg)",
                color: badge.className === "bestseller" || badge.className === "new" ? "var(--bg)" : "var(--ink)",
        ...
        <div className="product-card__info">
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", marginTop: "0.25rem" }}>
            <p style={{ fontSize: "0.95rem", color: "var(--ink)", fontWeight: 500 }}>
              {formatPrice(product.priceCents, product.currency)}
            </p>
            {product.compareAtPriceCents && product.compareAtPriceCents > product.priceCents && (
              <p style={{ fontSize: "0.85rem", color: "var(--muted)", textDecoration: "line-through" }}>
