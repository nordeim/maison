 ...
 *
 * Extracted from `apps/web/src/app/(shop)/checkout/page.tsx` so the page
...
export function CheckoutFlow() {
  ...
  const shippingCost = appliedPromo?.freeShipping
    ? 0
    : (SHIPPING_COSTS[shipping.shippingMethod] ?? 0);
        ...
        >
          ...
          >
            ...
            <li>
              ...
              {SHIPPING_LABELS[shipping.shippingMethod]?.split('(')[1]?.replace(')', '') ??
                '5–7 days'}
            </li>
          </ol>
        </div>
          ...
          <div key={s} style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
            ...
            <span
              style={{
                ...
                color: step === s ? 'var(--ink)' : 'var(--muted)',
        ...
        <div>
                  ...
                  >
                    <input
                      ...
                      onChange={() => {
                        setShipping({
                          ...shipping,
                          shippingMethod: method as ShippingInfo['shippingMethod'],
                        });
                      }}
          ...
          {step === 'payment' && (
            ...
            >
              ...
              >
                🔒 Phase 1 demo mode — no real payment is processed. Stripe Elements integration is
                wired but not active. Click &quot;Continue to Review&quot; to proceed.
              </p>
              <div
                style={{
                  padding: '1.5rem',
              ...
              >
                ...
                >
                  In production, Stripe Elements will collect card data securely here. Card data
              ...
              <div>
                ...
                <p style={{ fontSize: 11, color: 'var(--muted)' }}>
                  {appliedPromo.type === 'percentage'
                    ? appliedPromo.discountAmountCents > 0
                      ? `-${formatPrice(appliedPromo.discountAmountCents)}`
                      : ''
                    : ''}
