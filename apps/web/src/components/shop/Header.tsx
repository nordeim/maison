    ...
    <>
      ...
      >
        ...
        >
          ...
          {/* Desktop nav */}
          <nav style={{ display: "flex", gap: "2.25rem", alignItems: "center" }} aria-label="Primary">
            {navLinks.map((link) => (
              <Link
                key={link.href}
                href={link.href}
      ...
      {mobileNavOpen && (
        ...
        >
          ...
          >
            ...
            <p style={{ fontSize: 11, letterSpacing: "0.22em", textTransform: "uppercase", color: "var(--muted)", marginBottom: "0.5rem" }}>
              Menu
            </p>
            {navLinks.map((link) => (
              <Link
