/**
 * Maison — Shopping bag view (Client Component)
 *
 * Extracted from `apps/web/src/app/(shop)/cart/page.tsx` so the page
          ...
          <div style={{ marginBottom: '1.5rem' }}>
            ...
            >
              {remainingForFreeShipping > 0 ? (
                <>
                  Spend <strong>{formatPrice(remainingForFreeShipping)}</strong> more for free
                  shipping
                </>
              ) : (
            ...
            >
              <div
                style={{
                  height: '100%',
                  width: `${String(freeShippingProgress)}%`,
                  background: 'var(--clay)',
