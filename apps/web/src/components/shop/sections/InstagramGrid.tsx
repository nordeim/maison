    ...
    <section style={{ padding: "clamp(64px, 9vw, 120px) 0" }}>
      <div style={{ maxWidth: "var(--container)", margin: "0 auto", padding: "0 var(--gutter)" }}>
        <div style={{ textAlign: "center", marginBottom: "clamp(40px, 5vw, 64px)" }}>
          <span style={{ display: "inline-block", fontSize: 11, fontWeight: 500, letterSpacing: "0.22em", textTransform: "uppercase", color: "var(--clay)", marginBottom: "1rem" }}>Follow Us</span>
          <h2 style={{ fontFamily: "var(--font-serif)", fontSize: "clamp(2rem, 4.5vw, 3.4rem)", fontWeight: 500 }}>
            @maison<em style={{ color: "var(--clay)", fontStyle: "italic", fontWeight: 400 }}>living</em>
          </h2>
          <p style={{ fontSize: "1.0625rem", lineHeight: 1.7, color: "var(--ink-2)", maxWidth: "60ch", margin: "1rem auto 0" }}>
            Join our community and get inspired by curated spaces and behind-the-scenes moments from our makers.
          </p>
        </div>
