      ...
      >
        ...
        >
          <Image
            ...
            style={{
              objectFit: 'cover',
              transition: 'transform 1.2s var(--ease-maison)',
            }}
          />
          <span
            style={{
        ...
        <div>
          ...
          >
            Sculptural forms that cast warmth and shadow — each piece mouth-blown, hand-bent, or
            wheel-thrown by Nordic makers who shape light as carefully as they shape material.
            Discover pendants, table lamps, and floor lights designed to transform any space into a
            sanctuary of warm, deliberate glow.
          </p>
          <div
            style={{
              display: 'flex',
          ...
          <a
            href="/products?collection=lighting"
            style={{
              display: 'inline-flex',
              alignItems: 'center',
              gap: '0.625rem',
