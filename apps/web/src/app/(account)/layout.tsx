    ...
    <div style={{ maxWidth: 1280, margin: "0 auto", padding: "3rem 1.25rem" }}>
      <aside style={{ marginBottom: "2rem" }}>
        ...
        <h1 style={{ fontSize: "clamp(1.5rem, 3vw, 2rem)", fontWeight: 400 }}>
          Hello, <em style={{ color: "#a86b4a" }}>{session.user.name ?? session.user.email}</em>
        </h1>
      </aside>
      ...
      >
        <a href="/account" style={{ fontSize: "0.875rem", color: "#1f1b17", borderBottom: "1px solid #1f1b17", paddingBottom: "2px" }}>
          Dashboard
        </a>
