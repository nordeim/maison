...
export default async function AdminProductsPage() {
  ...
  try {
    ...
    products = await caller.admin.productsList({ status: 'all', limit: 50 });
  } catch (err) {
    ...
    <div>
      ...
      {products.items.length === 0 ? (
        <p style={{ color: 'var(--muted)', padding: '2rem 0' }}>
          No products found. Run <code style={{ color: 'var(--clay)' }}>pnpm db:seed</code> to load
          the catalog.
        </p>
      ) : (
                  ...
                  <td style={{ padding: '0.75rem 1rem' }}>
                    <span
                      style={{
                        ...
                        textTransform: 'uppercase',
                        letterSpacing: '0.1em',
                        color: product.isActive ? 'var(--sage)' : 'var(--muted)',
                      }}
                    >
