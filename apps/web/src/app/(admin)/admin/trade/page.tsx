...
export default async function AdminTradePage() {
  ...
  return (
    <div>
      ...
      >
        Trade Applications ({applications.length})
      </h2>
          ...
          {applications.map((app) => (
            ...
            >
              ...
              >
                ...
                {app.projectTypes && (
                  <p>
                    <strong>Project Types:</strong> {app.projectTypes}
                  </p>
                )}
              </div>
              {app.status === 'pending' && (
                <TradeActions applicationId={app.id} defaultDiscount={app.discountPercent} />
              )}
            </div>
          ))}
        </div>
