  ...
  return (
    <main style={{ maxWidth: 760, margin: "0 auto", padding: "5rem 1.25rem" }}>
      ...
      <p style={{ color: "#4a433b", marginBottom: "2rem" }}>
        Questions about a piece, a commission, or a trade inquiry? Write to us — we read every email.
      </p>
      ...
      <form style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
        <input
          ...
          style={{ padding: "0.75rem", border: "1px solid #e5ddd1", background: "#ffffff", fontSize: 16 }}
        />
        <input
          type="email"
        ...
        <textarea
          ...
          rows={6}
          style={{ padding: "0.75rem", border: "1px solid #e5ddd1", background: "#ffffff", fontSize: 16, resize: "vertical" }}
        />
        <button
          type="submit"
          style={{
