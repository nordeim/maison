...
**Current progress:** Phase 2 Growth complete. The storefront now supports wishlist persistence, promo codes, product search, full address book management, account settings, editorial About page, and admin discount management. Phase 3 optimisation per `docs/PRD_unified.md` §18 to commence.
