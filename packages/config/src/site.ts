...
export const site = {
  ...
  footer: {
    ...
    socials: [
      { label: "Instagram", href: "https://instagram.com/maisonliving", icon: "instagram" },
      { label: "Pinterest", href: "https://pinterest.com/maisonliving", icon: "pinterest" },
      { label: "YouTube", href: "https://youtube.com/@maisonliving", icon: "youtube" },
